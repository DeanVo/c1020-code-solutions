...
function renderPokemon(pokemon) {
  ...
  var pokemonTextDiv = document.createElement('div');
  var pokemonName = document.createElement('h2');
  var pokemonNum = document.createElement('h3');
  ...
  pokemonTextDiv.setAttribute('class', 'pokemon-card-text');

  pokemonName.textContent = pokemon.name;
  pokemonNum.textContent = '#' + pokemon.number;
  pokemonDesc.textContent = pokemon.description;

  newDiv.appendChild(pokemonCardDiv);
  pokemonCardDiv.appendChild(imageElement);
  pokemonCardDiv.appendChild(pokemonTextDiv);
  pokemonTextDiv.appendChild(pokemonName);
  pokemonTextDiv.appendChild(pokemonNum);
  pokemonTextDiv.appendChild(pokemonDesc);
...
for (var i = 0; i < pokedex.length; i++) {
  newRow.appendChild(renderPokemon(pokedex[i]));
}
